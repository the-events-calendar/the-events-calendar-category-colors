<table class="teccc form-table">
	...
	<style type="text/css">.form-table th { font-size: 12px; }</style>
		...
		<?php if ( empty( $teccc->terms) ): ?>
			<div class="error" style="text-align:center;padding:1em;"> <?php _e( 'You must have at least one event with a category for The Events Calendar Category Colors plugin to function.', 'teccc' ) ?> </div>
		<?php endif ?>
