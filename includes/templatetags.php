...
function teccc_remove_default_legend() {
	return Tribe__Events__Category_Colors::instance()->public->remove_default_legend();
}
...
function teccc_reposition_legend( $viewFilter ) {
	return Tribe__Events__Category_Colors::instance()->public->reposition_legend( $viewFilter );
}
...
function teccc_insert_legend() {
	...
	Tribe__Events__Category_Colors::instance()->public->show_legend();
}
...
function teccc_add_text_color( $name, $value ) {
	Tribe__Events__Category_Colors::instance()->text_colors[$name] = $value;
}
...
function teccc_ignore_slug() {
	...
	foreach ( $slugs as $slug ) {
		Tribe__Events__Category_Colors::instance()->ignore_list[] = $slug;
	}
}
...
function teccc_add_legend_view( $view ) {
	Tribe__Events__Category_Colors::instance()->public->add_legend_view( $view );
}
